    ...
    <div class="d-flex justify-content-center">
        <div class="col card card-primary">
            <div class="card-header">
                <h3 class="card-title">{{ ucwords($type) }} Unit Form</h3>
            </div>
                ...
                <x-form :action="$action" :type="$type">
                    <div class="row">
                        ...
                        <div class="col form-group">
                            ...
                            <x-text-input name="symbol" placeholder="house" :value="$obj->symbol ?? ''" :disabled="$type == 'show'"></x-text-input>
                            <x-input-error :messages="$errors->get('symbol')" class="mt-2" />
                        </div>                        
                        <div class="col-12 form-group">
                            <label for="description">Description</label>
                            <x-textarea name="description" placeholder="Enter unit description here..." :value="$obj->description ?? ''" :disabled="$type == 'show'"></x-textarea>
                            <x-input-error :messages="$errors->get('description')" class="mt-2" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col d-flex justify-content-between">
                            <a class="col-3" href="{{route('unit.index')}}">
